...
{
public:
	unsigned char                                      UnknownData_G3NS[0x790];                                   // 0x0028(0x0790) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistryImpl"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistryHelpers"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AssetRegistry.AssetRegistry"));
		return ptr;
	}
