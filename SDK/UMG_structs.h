...
{
	unsigned char                                      UnknownData_TXT1[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimationEventBinding
{
	...
	unsigned char                                      UnknownData_04L6[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_84HC[0x4];                                     // 0x0024(0x0004) MISSED OFFSET (PADDING)
...
struct FMovieSceneMarginSectionTemplate : public FMovieScenePropertySectionTemplate
{
	...
	unsigned char                                      UnknownData_PCTA[0x7];                                     // 0x02B9(0x0007) MISSED OFFSET (PADDING)
...
struct FRadialBoxSettings
{
	...
	unsigned char                                      UnknownData_T9D0[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_2C69[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
struct FWidgetNavigationData
{
	...
	unsigned char                                      UnknownData_4QW1[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FUserWidgetPool
{
	...
	unsigned char                                      UnknownData_CH89[0x60];                                    // 0x0020(0x0060) MISSED OFFSET (PADDING)
...
struct FSlateChildSize
{
	...
	unsigned char                                      UnknownData_HX50[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (PADDING)
...
struct FWidgetAnimationBinding
{
	...
	unsigned char                                      UnknownData_1KMQ[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FBlueprintWidgetAnimationDelegateBinding
{
	...
	unsigned char                                      UnknownData_AO43[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FDelegateRuntimeBinding
{
	...
	unsigned char                                      UnknownData_0C1I[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
struct FEventReply
{
	unsigned char                                      UnknownData_EVR3[0xB8];                                    // 0x0000(0x00B8) MISSED OFFSET (PADDING)
