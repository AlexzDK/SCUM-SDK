...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.AudioSynesthesiaNRTSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.AudioSynesthesiaNRT"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.LoudnessNRT"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_4NFS[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0UXA[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.OnsetNRTSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.OnsetNRT"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_KFKR[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.ConstantQNRTSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.ConstantQNRT"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BGNN[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6EP9[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioSynesthesia.LoudnessNRTSettings"));
		return ptr;
	}
