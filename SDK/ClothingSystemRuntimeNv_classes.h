...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothingSimulationFactoryNv"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_Z7QR[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothingSimulationInteractorNv"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothPhysicalMeshDataNv_Legacy"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_SL5H[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_QW8Q[0x3];                                     // 0x00E5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3QWK[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeNv.ClothConfigNv"));
		return ptr;
	}
