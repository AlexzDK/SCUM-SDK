...
public:
	...
	unsigned char                                      UnknownData_5G7B[0x18];                                    // 0x03C8(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.SynthSound"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZBAH[0x8];                                     // 0x01F8(0x0008) Fix Super Size
	...
	unsigned char                                      UnknownData_YDZN[0x3];                                     // 0x0649(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4QUZ[0x4];                                     // 0x0654(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R8PG[0x20];                                    // 0x0668(0x0020) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_A48I[0x28];                                    // 0x0698(0x0028) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.SynthComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_3SKO[0x80];                                    // 0x0028(0x0080) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.AudioGenerator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.AudioMixerBlueprintLibrary"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_W7T5[0x168];                                   // 0x0028(0x0168) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.QuartzClockHandle"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_DU91[0x78];                                    // 0x0068(0x0078) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.SubmixEffectDynamicsProcessorPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OUI1[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_ZKPZ[0x68];                                    // 0x0068(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
public:
	unsigned char                                      UnknownData_CEMP[0x50];                                    // 0x0030(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioMixer.QuartzSubsystem"));
		return ptr;
	}
