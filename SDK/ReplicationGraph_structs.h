...
{
	unsigned char                                      UnknownData_LWM0[0x8];                                     // 0x0000(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LHUU[0x8];                                     // 0x0010(0x0008) MISSED OFFSET (PADDING)
...
struct FClassReplicationInfo
{
	...
	unsigned char                                      UnknownData_Q344[0x56];                                    // 0x0012(0x0056) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
