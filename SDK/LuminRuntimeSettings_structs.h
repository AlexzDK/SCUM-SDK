...
struct FLuminComponentSubElement
{
	...
	unsigned char                                      UnknownData_L6MX[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FLuminComponentElement
{
	...
	unsigned char                                      UnknownData_NZIF[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
