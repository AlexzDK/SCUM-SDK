...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function Paper2D.PaperFlipbookComponent.GetSpriteColor"));
...
{
	static auto fn = UObject::FindObject<UFunction>(_xor_("Function Paper2D.PaperSpriteBlueprintLibrary.MakeBrushFromSprite"));
