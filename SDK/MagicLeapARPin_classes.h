...
public:
	...
	unsigned char                                      UnknownData_WOWP[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCBB[0xF];                                     // 0x00A1(0x000F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinSaveGame"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinContentBindings"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_P8Y1[0x2];                                     // 0x020E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TK0Y[0xF0];                                    // 0x02C0(0x00F0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinFunctionLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_Z1XA[0x7];                                     // 0x0231(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinInfoActorBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_210P[0x7];                                     // 0x0221(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TMap<struct FGuid, class AMagicLeapARPinInfoActorBase*> AllInfoActors;                                             // 0x0228(0x0050) (NativeAccessSpecifierPrivate)
	unsigned char                                      UnknownData_981N[0x8];                                     // 0x0278(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinRenderer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapARPin.MagicLeapARPinSettings"));
		return ptr;
	}
