...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerAsset"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerNRTSettings"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_OPNG[0x44];                                    // 0x0034(0x0044) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AudioAnalyzer.AudioAnalyzerNRT"));
		return ptr;
	}
