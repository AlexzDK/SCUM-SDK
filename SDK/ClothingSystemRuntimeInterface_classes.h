...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothConfigBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothingSimulationFactory"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OD3B[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothingSimulationInteractor"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothSharedSimConfigBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothingAssetBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_SQ5S[0x50];                                    // 0x0090(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeInterface.ClothPhysicalMeshDataBase_Legacy"));
		return ptr;
	}
