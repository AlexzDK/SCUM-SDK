...
struct FAnimNode_SkeletalControlBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_GOWV[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VGNT[0x10];                                    // 0x00B8(0x0010) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_G13R[0x10];                                    // 0x00C8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_RigidBody : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_ALHH[0x98];                                    // 0x00D0(0x0098) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GAFK[0x1];                                     // 0x01FB(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UG9U[0x3];                                     // 0x01FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OP5I[0x448];                                   // 0x0208(0x0448) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotateRootBone : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_TT5G[0xC];                                     // 0x0094(0x000C) MISSED OFFSET (PADDING)
...
struct FAnimNode_RotationMultiplier : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_LL4K[0x2];                                     // 0x00EE(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpacePlayer : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_SMBL[0x2];                                     // 0x004A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6JMT[0x88];                                    // 0x0058(0x0088) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RotationOffsetBlendSpace : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_W2M1[0x4];                                     // 0x0188(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BFPZ[0x2];                                     // 0x018E(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_ScaleChainLength : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_CA6I[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_XNSB[0x17];                                    // 0x0061(0x0017) MISSED OFFSET (PADDING)
...
struct FAnimNode_SequenceEvaluator : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_1P7M[0x1];                                     // 0x0047(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WB3M[0x4];                                     // 0x004C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_Slot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZRM7[0x1F];                                    // 0x0029(0x001F) MISSED OFFSET (PADDING)
...
struct FAnimNode_SplineIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_ZB8H[0x2];                                     // 0x00EA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_LDI1[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5M38[0x128];                                   // 0x0148(0x0128) MISSED OFFSET (PADDING)
...
struct FRBFTarget : public FRBFEntry
{
	...
	unsigned char                                      UnknownData_PK6T[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_789X[0x6];                                     // 0x009A(0x0006) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TTU6[0x30];                                    // 0x0000(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PHQ8[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)
...
struct FConstraint
{
	...
	unsigned char                                      UnknownData_3G0A[0x7];                                     // 0x0015(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_Constraint : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_4D1Y[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_J7HG[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_CopyPoseFromMesh : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_6XKY[0x1];                                     // 0x001B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AGCZ[0x1B4];                                   // 0x0024(0x01B4) MISSED OFFSET (PADDING)
...
struct FAnimNode_CurveSource : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_K1L7[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FBoneSocketTarget
{
	...
	unsigned char                                      UnknownData_FKRT[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FBoneReference                              BoneReference;                                             // 0x0004(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_3ZD9[0xC];                                     // 0x0014(0x000C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_0T7X[0x8];                                     // 0x00C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_18RS[0x6];                                     // 0x018A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_HandIKRetargeting : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_VRZ1[0x4];                                     // 0x011C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_LayeredBoneBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_TT03[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_25VK[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YHN8[0x30];                                    // 0x0090(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimNode_LegIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_FKTL[0x18];                                    // 0x00E0(0x0018) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_5PNR[0x68];                                    // 0x00E8(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_499R[0x30];                                    // 0x0190(0x0030) MISSED OFFSET (PADDING)
...
struct FAnimPhysConstraintSetup
{
	...
	unsigned char                                      UnknownData_VC7D[0x1];                                     // 0x0003(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9CBS[0x1];                                     // 0x001F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimPhysSphericalLimit
{
	...
	unsigned char                                      UnknownData_9BLX[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (PADDING)
...
struct FRotationRetargetingInfo
{
	...
	unsigned char                                      UnknownData_9QA3[0xF];                                     // 0x0001(0x000F) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MBUN[0x3];                                     // 0x0071(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PPHO[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RD58[0x3];                                     // 0x0095(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RY11[0x3];                                     // 0x0121(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7EJZ[0x7];                                     // 0x0129(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_AnimDynamics : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_AWEA[0x60];                                    // 0x00D0(0x0060) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1ELY[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UNQA[0x2];                                     // 0x0242(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2JD : 1;                                      // 0x0245(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_QSAX[0xA];                                     // 0x0246(0x000A) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FRotationRetargetingInfo                    RetargetingSettings;                                       // 0x0250(0x0130) (Edit, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OCRL[0xC0];                                    // 0x0380(0x00C0) MISSED OFFSET (PADDING)
...
struct FAnimNode_ApplyAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_82B6[0x4];                                     // 0x00C0(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2OVX[0x2];                                     // 0x00C6(0x0002) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseHandler : public FAnimNode_AssetPlayerBase
{
	...
	unsigned char                                      UnknownData_280P[0x40];                                    // 0x0040(0x0040) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseBlendNode : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_U39H[0x7];                                     // 0x0091(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseByName : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_TN2J[0xC];                                     // 0x008C(0x000C) MISSED OFFSET (PADDING)
...
struct FPoseDriverTarget
{
	...
	unsigned char                                      UnknownData_O45T[0x5];                                     // 0x0023(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_67C9[0x8];                                     // 0x00B0(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDZ1[0x7];                                     // 0x00B9(0x0007) MISSED OFFSET (PADDING)
...
struct FRBFParams
{
	...
	unsigned char                                      UnknownData_J6RC[0x3];                                     // 0x0005(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4MKH[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_PoseDriver : public FAnimNode_PoseHandler
{
	...
	unsigned char                                      UnknownData_ATQK[0x30];                                    // 0x00C0(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VQL1[0x1];                                     // 0x012F(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6456[0x4];                                     // 0x0134(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_PoseSnapshot : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_2N2D[0x3F];                                    // 0x0051(0x003F) MISSED OFFSET (PADDING)
...
struct FRandomPlayerSequenceEntry
{
	...
	unsigned char                                      UnknownData_VAVF[0x4];                                     // 0x001C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_RandomPlayer : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_M1MC[0x50];                                    // 0x0020(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MBEW[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_RefPose : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_TBI9[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_ON9U[0xA0];                                    // 0x0000(0x00A0) MISSED OFFSET (PADDING)
...
struct FIKChain
{
	unsigned char                                      UnknownData_B1J0[0x38];                                    // 0x0000(0x0038) MISSED OFFSET (PADDING)
...
struct FIKChainLink
{
	unsigned char                                      UnknownData_VZDP[0x3C];                                    // 0x0000(0x003C) MISSED OFFSET (PADDING)
...
{
	struct FBoneReference                              BoneToModify;                                              // 0x00C8(0x0010) (Edit, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_NK8T[0x8];                                     // 0x00D8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VX6Z[0x2];                                     // 0x015E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3IUE[0x34];                                    // 0x017C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_MakeDynamicAdditive : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_624G[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_XLIA[0x6];                                     // 0x0102(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ModifyCurve : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_FHV9[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_CGK7[0x3];                                     // 0x0055(0x0003) MISSED OFFSET (PADDING)
...
struct FAnimNode_MultiWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_VFSS[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1V6Q[0x6];                                     // 0x004A(0x0006) MISSED OFFSET (PADDING)
...
struct FAnimNode_ObserveBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_PM7G[0x2];                                     // 0x00DA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FAnimNode_SpringBone : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_VLFI[0x3C];                                    // 0x00E8(0x003C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8JA7[0x3];                                     // 0x0125(0x0003) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_RT3B[0x38];                                    // 0x00C8(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I4T4[0x2];                                     // 0x0116(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_20PV[0x34];                                    // 0x022C(0x0034) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwistCorrectiveNode : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_X04J[0x8];                                     // 0x0130(0x0008) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoBoneIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_LQDT[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_81TJ[0x4];                                     // 0x015C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D1WS[0xD];                                     // 0x01D3(0x000D) MISSED OFFSET (PADDING)
...
struct FAnimNode_TwoWayBlend : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_MTGQ : 2;                                      // 0x0031(0x0001) BIT_FIELD (PADDING)
	...
	unsigned char                                      UnknownData_HCLM[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	struct FName                                       AlphaCurveName;                                            // 0x0088(0x0008) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	struct FInputScaleBiasClamp                        AlphaScaleBiasClamp;                                       // 0x0090(0x0030) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_BF2Z[0x8];                                     // 0x00C0(0x0008) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_FUIA[0x2A0];                                   // 0x0760(0x02A0) MISSED OFFSET (PADDING)
...
struct FPositionHistory
{
	...
	unsigned char                                      UnknownData_8RKI[0x1C];                                    // 0x0014(0x001C) MISSED OFFSET (PADDING)
...
struct FBlendBoneByChannelEntry
{
	...
	unsigned char                                      UnknownData_K7SP[0x1];                                     // 0x0023(0x0001) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendBoneByChannel : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_ZQER[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              Alpha;                                                     // 0x0050(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_PWMV[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PS2X[0x7];                                     // 0x0061(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListBase : public FAnimNode_Base
{
	...
	unsigned char                                      UnknownData_YCK4[0x5];                                     // 0x0033(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DHZ5[0x50];                                    // 0x0048(0x0050) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByBool : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_2A4A[0x7];                                     // 0x0099(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByEnum : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_GOSD[0x7];                                     // 0x00A9(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendListByInt : public FAnimNode_BlendListBase
{
	...
	unsigned char                                      UnknownData_U1QE[0x4];                                     // 0x009C(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BlendSpaceEvaluator : public FAnimNode_BlendSpacePlayer
{
	...
	unsigned char                                      UnknownData_N08L[0x4];                                     // 0x00EC(0x0004) MISSED OFFSET (PADDING)
...
struct FAnimNode_BoneDrivenController : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_MCRJ[0x7];                                     // 0x0111(0x0007) MISSED OFFSET (PADDING)
...
struct FAnimNode_CCDIK : public FAnimNode_SkeletalControlBase
{
	...
	unsigned char                                      UnknownData_OZ2F[0xB];                                     // 0x00D5(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X8HA[0x6];                                     // 0x016A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
