...
struct FHairInterpolationSettings
{
	...
	unsigned char                                      UnknownData_XRQR[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupCardsTextures
{
	...
	unsigned char                                      UnknownData_72F5[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (PADDING)
...
struct FHairBendConstraint
{
	...
	unsigned char                                      UnknownData_5LQ2[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_Q26E[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStretchConstraint
{
	...
	unsigned char                                      UnknownData_6RMH[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V6HR[0x4];                                     // 0x000C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairCollisionConstraint
{
	...
	unsigned char                                      UnknownData_JZXZ[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairStrandsParameters
{
	...
	unsigned char                                      UnknownData_X37D[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairSolverSettings
{
	...
	unsigned char                                      UnknownData_YANU[0x6];                                     // 0x0002(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupsPhysics
{
	...
	unsigned char                                      UnknownData_8SUP[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairCardsClusterSettings
{
	...
	unsigned char                                      UnknownData_PSHN[0x2];                                     // 0x0006(0x0002) MISSED OFFSET (PADDING)
...
struct FHairCardsGeometrySettings
{
	...
	unsigned char                                      UnknownData_UDX3[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_7QBL[0x3];                                     // 0x0009(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairLODSettings
{
	...
	unsigned char                                      UnknownData_CNAL[0x2];                                     // 0x0016(0x0002) MISSED OFFSET (PADDING)
...
struct FHairShadowSettings
{
	...
	unsigned char                                      UnknownData_XVME[0x2];                                     // 0x000A(0x0002) MISSED OFFSET (PADDING)
...
struct FHairGroupDesc
{
	...
	unsigned char                                      UnknownData_XS4W[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1ZPH[0x3];                                     // 0x0019(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_T7QX[0x3];                                     // 0x0021(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZMO3[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CLDS[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2RH5[0x1];                                     // 0x003B(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8O3C[0x2];                                     // 0x0046(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	bool                                               bOverrideGuides;                                           // 0x0000(0x0001) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_55MU[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              HairToGuideDensity;                                        // 0x0004(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
...
struct FHairGroupsCardsSourceDescription
{
	...
	unsigned char                                      UnknownData_M4OC[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FHairGroupInfoWithVisibility : public FHairGroupInfo
{
	...
	unsigned char                                      UnknownData_GTAV[0x3];                                     // 0x0015(0x0003) MISSED OFFSET (PADDING)
...
struct FHairGroupsRendering
{
	...
	unsigned char                                      UnknownData_OFNI[0x2];                                     // 0x002E(0x0002) MISSED OFFSET (PADDING)
...
struct FFollicleMaskOptions
{
	...
	unsigned char                                      UnknownData_7C64[0x7];                                     // 0x0009(0x0007) MISSED OFFSET (PADDING)
