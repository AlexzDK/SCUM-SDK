...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicalMaterialPropertyBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_LDL0[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_CR11[0x2];                                     // 0x005E(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_DUC3[0x2];                                     // 0x0076(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FChaosSolverConfiguration                   SolverOptions;                                             // 0x0078(0x0068) (Edit, Config, NoDestructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicsSettingsCore"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NKAJ[0x15];                                    // 0x0033(0x0015) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PhysicsCore.BodySetupCore"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0Q1J[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PhysicsCore.ChaosPhysicalMaterial"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_2OSD[0x2];                                     // 0x0032(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OQ8O[0x2];                                     // 0x003A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_IKFI[0x4];                                     // 0x0054(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OFV3[0x1F];                                    // 0x0061(0x001F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class PhysicsCore.PhysicalMaterial"));
		return ptr;
	}
