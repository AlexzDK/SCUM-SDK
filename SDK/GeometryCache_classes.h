...
public:
	...
	unsigned char                                      UnknownData_RTVI[0x2C];                                    // 0x002C(0x002C) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_6OHP[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_71KN[0xA8];                                    // 0x0058(0x00A8) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCache.GeometryCacheCodecBase"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_DEZI[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCache.GeometryCacheCodecV1"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_GSAG[0x2];                                     // 0x0472(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SMDH[0x30];                                    // 0x0484(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3FJK[0x7];                                     // 0x04B9(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_AA4H[0x24];                                    // 0x005C(0x0024) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_WYTV[0x68];                                    // 0x0060(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_AH61[0x4];                                     // 0x00CC(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCache.GeometryCacheTrackStreamable"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_PDHX[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MTL9[0x10];                                    // 0x0050(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_5VFL[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCache.GeometryCacheCodecRaw"));
		return ptr;
	}
