...
// 0x0D72 (FullSize[0x102A] - InheritedSize[0x02B8])
class UABP_Prisoner_FirstPersonAimRotation_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_UKXZ[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	ConZ_EPrisonerStance                               Stance;                                                    // 0x1029(0x0001) (Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass ABP_Prisoner_FirstPersonAimRotation.ABP_Prisoner_FirstPersonAimRotation_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_ABP_Prisoner_FirstPersonAimRotation(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
