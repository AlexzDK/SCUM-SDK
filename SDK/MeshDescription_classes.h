...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class MeshDescription.MeshDescription"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_5P0N[0x368];                                   // 0x0028(0x0368) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MeshDescription.MeshDescriptionBase"));
		return ptr;
	}
