...
{
public:
	unsigned char                                      UnknownData_0ABP[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCollectionTracks.MovieSceneGeometryCollectionTrack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class GeometryCollectionTracks.MovieSceneGeometryCollectionSection"));
		return ptr;
	}
