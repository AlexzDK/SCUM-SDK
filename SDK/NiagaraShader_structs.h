...
{
	unsigned char                                      UnknownData_ZNA8[0x28];                                    // 0x0000(0x0028) MISSED OFFSET (PADDING)
...
struct FSimulationStageMetaData
{
	...
	unsigned char                                      UnknownData_Y1HN[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FNiagaraCompileEvent
{
	...
	unsigned char                                      UnknownData_MHHI[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
