...
struct FMagicLeapMeshBlockRequest
{
	...
	unsigned char                                      UnknownData_8N5U[0x3];                                     // 0x0011(0x0003) MISSED OFFSET (PADDING)
...
struct FMagicLeapRaycastQueryParams
{
	...
	unsigned char                                      UnknownData_9B2Z[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapHeadTrackingState
{
	...
	unsigned char                                      UnknownData_TA4J[0x2];                                     // 0x0002(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapResult
{
	...
	unsigned char                                      UnknownData_FWDC[0x7];                                     // 0x0001(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FMagicLeapMeshBlockInfo
{
	...
	unsigned char                                      UnknownData_980L[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9AEP[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (PADDING)
...
struct FMagicLeapRaycastHitResult
{
	...
	unsigned char                                      UnknownData_HO6F[0x3];                                     // 0x0001(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	unsigned char                                      UnknownData_FD8N[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_66OM[0x28];                                    // 0x0020(0x0028) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HTR8[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_TK0S[0x10];                                    // 0x0000(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1AAP[0xF];                                     // 0x0031(0x000F) MISSED OFFSET (PADDING)
