...
public:
	...
	unsigned char                                      UnknownData_A4H1[0x27];                                    // 0x0031(0x0027) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class TimeManagement.GenlockedTimecodeProvider"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class TimeManagement.TimeManagementBlueprintLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_Z0J4[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class TimeManagement.TimeSynchronizationSource"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class TimeManagement.FixedFrameRateCustomTimeStep"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class TimeManagement.GenlockedCustomTimeStep"));
		return ptr;
	}
