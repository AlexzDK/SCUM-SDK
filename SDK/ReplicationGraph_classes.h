...
public:
	...
	unsigned char                                      UnknownData_FZKZ[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0I11[0xA8];                                    // 0x0050(0x00A8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_ActorList"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_8A3J[0x10];                                    // 0x00F8(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_DormancyNode"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZUO5[0x48];                                    // 0x00F8(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_GridCell"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_DXEB[0x1E0];                                   // 0x0050(0x01E0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_GridSpatialization2D"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_K8JB[0x10];                                    // 0x0058(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_AlwaysRelevant"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OPQI[0xE8];                                    // 0x0050(0x00E8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_ActorListFrequencyBuckets"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_HI23[0x30];                                    // 0x00F8(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_DynamicSpatialFrequency"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WHYV[0x98];                                    // 0x00F8(0x0098) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_ConnectionDormancyNode"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_U5MA[0x18];                                    // 0x00F8(0x0018) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FAlwaysRelevantActorInfo>            PastRelevantActors;                                        // 0x0110(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_AlwaysRelevant_ForConnection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_LOWD[0x18];                                    // 0x0060(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphNode_TearOff_ForConnection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_UVYL[0x140];                                   // 0x0030(0x0140) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_52SY[0x10];                                    // 0x0178(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FLastLocationGatherInfo>             LastGatherLocations;                                       // 0x0188(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_7WHG[0x8];                                     // 0x0198(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R2F9[0x80];                                    // 0x01B8(0x0080) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.NetReplicationGraphConnection"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraphDebugActor"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NSCV[0x40];                                    // 0x0058(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_2PQY[0x3E0];                                   // 0x00B8(0x03E0) Fix Super Size


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.ReplicationGraph"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_D0LU[0x8];                                     // 0x04C8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ReplicationGraph.BasicReplicationGraph"));
		return ptr;
	}
