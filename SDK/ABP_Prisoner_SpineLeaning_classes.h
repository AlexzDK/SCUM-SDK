...
// 0x06D4 (FullSize[0x098C] - InheritedSize[0x02B8])
class UABP_Prisoner_SpineLeaning_C : public UAnimInstance
{
public:
	unsigned char                                      UnknownData_IXVX[0x8];                                     // 0x02B8(0x0008) Fix Super Size
	...
	{
		static auto ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass ABP_Prisoner_SpineLeaning.ABP_Prisoner_SpineLeaning_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_ABP_Prisoner_SpineLeaning(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
