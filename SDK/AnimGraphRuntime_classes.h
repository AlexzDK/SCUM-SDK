...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class AnimGraphRuntime.AnimNotify_PlayMontageNotify"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AnimGraphRuntime.AnimNotify_PlayMontageNotifyWindow"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_HSBE[0x8];                                     // 0x02B8(0x0008) Fix Super Size
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AnimGraphRuntime.KismetAnimationLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BF10[0x30];                                    // 0x0078(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AnimGraphRuntime.PlayMontageCallbackProxy"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class AnimGraphRuntime.SequencerAnimationSupport"));
		return ptr;
	}
