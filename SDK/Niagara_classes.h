...
{
public:
	unsigned char                                      UnknownData_3N4L[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceRWBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraTrack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraParameterTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_YDR5[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraBoolParameterTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_PGV7[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraColorParameterTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_OCK1[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraFloatParameterTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_8JHM[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraIntegerParameterTrack"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_6WNR[0x3];                                     // 0x00E8(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_MRRQ[0x3];                                     // 0x00EC(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_50T8[0x3];                                     // 0x00F0(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_G4QY[0x3];                                     // 0x00F5(0x0003) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraSystemSpawnSection"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_SZF3[0x8];                                     // 0x0088(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraSystemTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_GWKE[0x8];                                     // 0x00A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0866[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.MovieSceneNiagaraVectorParameterTrack"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_L5C5[0x7];                                     // 0x0229(0x0007) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_CVE0[0x7];                                     // 0x0449(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9H99[0x2B];                                    // 0x0519(0x002B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EDO8[0x3];                                     // 0x0545(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FS9I[0x4];                                     // 0x054C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0FQ7[0x8];                                     // 0x0560(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BPBE[0x65];                                    // 0x058B(0x0065) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_YIBS[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraComponentPool"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_OF99[0x22];                                    // 0x005E(0x0022) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraRendererProperties"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_VS4P[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WMQB[0x6];                                     // 0x00EA(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0OYC[0x58];                                    // 0x0108(0x0058) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraComponentRendererProperties"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraComponentSettings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraConvertInPlaceUtilityBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterface2DArrayTexture"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_AP1O[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_J0LN[0xC];                                     // 0x0044(0x000C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArray"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayFloat"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayFloat2"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayFloat3"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayFloat4"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayColor"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayQuat"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayFunctionLibrary"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayInt32"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceArrayBool"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceAudioSubmix"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceAudioOscilloscope"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NIX5[0x3];                                     // 0x0061(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_I2RE[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceAudioPlayer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceAudioSpectrum"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_R4DL[0x3];                                     // 0x003D(0x0003) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceCamera"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_PYLN[0x10];                                    // 0x0038(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceCollisionQuery"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_W00D[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3Y97[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceCurveBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceColorCurve"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_B7TD[0xC];                                     // 0x003C(0x000C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceCurlNoise"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceCurve"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPrecompileContainer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_VLE9[0x4];                                     // 0x0034(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamInt32"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamFloat"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamVector2D"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamVector"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_AIKL[0x8];                                     // 0x0038(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamVector4"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewAxis_InterpParamLinearColor"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HMGP[0x7];                                     // 0x0229(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WEX5[0x8];                                     // 0x0268(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraPreviewGrid"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_M72J[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_8F6G[0x3];                                     // 0x00F5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L1ET[0x3];                                     // 0x00FD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NUXC[0x3];                                     // 0x0105(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V1E9[0x3];                                     // 0x010D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_65HY[0x98];                                    // 0x0740(0x0098) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Y5VE[0x3];                                     // 0x0029(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GTG1[0x10];                                    // 0x01A8(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_49FU[0x8];                                     // 0x02B8(0x0008) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_K4R5[0x20];                                    // 0x0028(0x0020) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_DIYV[0x6];                                     // 0x00B2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSettings"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NZKQ[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSimulationStageBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_8WK9[0x3];                                     // 0x0041(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UUBY[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FNiagaraVariableDataInterfaceBinding        DataInterface;                                             // 0x0050(0x0020) (Edit, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSimulationStageGeneric"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_Y6Z4[0x7];                                     // 0x0089(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_ZU0A[0x2];                                     // 0x00B2(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_GQS6[0x3];                                     // 0x00BD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_PU1R[0x3];                                     // 0x00C9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TID2[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V6WX[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VTEP[0x78];                                    // 0x0728(0x0078) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_GQ7W[0x1];                                     // 0x0033(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      bFixedBounds : 1;                                          // 0x0034(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_P0IZ[0x3];                                     // 0x0035(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YF8F[0x7];                                     // 0x0041(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_5I4H[0x10];                                    // 0x0098(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_UUSM[0x3];                                     // 0x03A5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_VIRD[0x3];                                     // 0x03B5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_G35R[0xB8];                                    // 0x03C8(0x00B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraParticleCallbackHandler"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_3M1O[0x3];                                     // 0x0059(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YCO7[0x4];                                     // 0x0064(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceExport"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGBuffer"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_19ZX[0x3];                                     // 0x00E9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_92HN[0x4];                                     // 0x00F4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGrid2D"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_PBKU[0x56];                                    // 0x011A(0x0056) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGrid2DCollection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_JLSL[0x50];                                    // 0x0118(0x0050) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGrid2DCollectionReader"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HV5A[0x3];                                     // 0x00EC(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_D4AS[0x4];                                     // 0x00FC(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGrid3D"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_HF9S[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_R41V[0x57];                                    // 0x0129(0x0057) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceGrid3DCollection"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceLandscape"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_46JN[0x4];                                     // 0x0104(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceNeighborGrid3D"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceOcclusion"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceParticleRead"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfacePlatformSet"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_K86X[0x6];                                     // 0x00E2(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceRenderTarget2D"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_RNSH[0x2];                                     // 0x00E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FNiagaraUserParameterBinding                RenderTargetUserParameter;                                 // 0x00E8(0x0020) (Edit, NativeAccessSpecifierPublic)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceRenderTarget2DArray"));
		return ptr;
	}
...
public:
	...
	TEnumAsByte<Engine_ETextureRenderTargetFormat>     OverrideRenderTargetFormat;                                // 0x00E4(0x0001) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      bOverrideFormat : 1;                                       // 0x00E5(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_Z98Q[0x2];                                     // 0x00E6(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FNiagaraUserParameterBinding                RenderTargetUserParameter;                                 // 0x00E8(0x0020) (Edit, NativeAccessSpecifierPublic)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceRenderTargetVolume"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceSimpleCounter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZA2U[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_B5AA[0x7];                                     // 0x0071(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SDYU[0x4];                                     // 0x008C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_X8G1[0x6];                                     // 0x00BA(0x0006) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceSkeletalMesh"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceSpline"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_XBMU[0x7];                                     // 0x0039(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_D46I[0x7];                                     // 0x0069(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<struct FName>                               FilteredSockets;                                           // 0x0070(0x0010) (Edit, ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_4KQV[0x8];                                     // 0x0080(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceStaticMesh"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceTexture"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceVector2DCurve"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceVector4Curve"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceVectorCurve"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_L9F4[0x5];                                     // 0x0043(0x0005) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceVectorField"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraDataInterfaceVolumeTexture"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraEditorDataBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSignificanceHandler"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSignificanceHandlerDistance"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraSignificanceHandlerAge"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_8I55[0x3];                                     // 0x0028(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_BTLD[0x3];                                     // 0x002C(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
	...
	unsigned char                                      UnknownData_3Y6I[0xA8];                                    // 0x0068(0x00A8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraEffectType"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZL4S[0x2];                                     // 0x002A(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1AIA[0x3];                                     // 0x0031(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0IQQ[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WSYM[0x4];                                     // 0x00C4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KP7T[0x3];                                     // 0x0109(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RHAL[0x7];                                     // 0x0169(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MRAF[0xD8];                                    // 0x01C8(0x00D8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraEmitter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_GSWC[0x4];                                     // 0x002C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_EIXE[0x3];                                     // 0x0081(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NWJA[0x4];                                     // 0x0094(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_V8VR[0x30];                                    // 0x02A8(0x0030) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraLightRendererProperties"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZTPH[0x3];                                     // 0x0089(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OMWN[0x3];                                     // 0x008D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OU9P[0x3];                                     // 0x00A9(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KEFQ[0x3];                                     // 0x00AD(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_C4OT[0x3];                                     // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_JMPX[0x3];                                     // 0x00C1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HRVI[0x3];                                     // 0x00D1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      bEnableCameraDistanceCulling : 1;                          // 0x00D4(0x0001) BIT_FIELD (Edit, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_O4UR[0x3];                                     // 0x00D5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	float                                              MinCameraDistance;                                         // 0x00D8(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	float                                              MaxCameraDistance;                                         // 0x00DC(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint32_t                                           RendererVisibility;                                        // 0x00E0(0x0004) (Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_E6UC[0x4];                                     // 0x00E4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FNiagaraVariableAttributeBinding            PositionBinding;                                           // 0x00E8(0x0058) (Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding            ColorBinding;                                              // 0x0140(0x0058) (Edit, NativeAccessSpecifierPublic)
	struct FNiagaraVariableAttributeBinding            VelocityBinding;                                           // 0x0198(0x0058) (Edit, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_PWO2[0x68];                                    // 0x0610(0x0068) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraMessageDataBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_UPLX[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraParameterCollectionInstance"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Niagara.NiagaraParameterCollection"));
		return ptr;
	}
