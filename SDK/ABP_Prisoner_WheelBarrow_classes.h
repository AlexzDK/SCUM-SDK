...
// 0x12F8 (FullSize[0x1698] - InheritedSize[0x03A0])
class UABP_Prisoner_WheelBarrow_C : public UPrisonerAnimInstance_WheelBarrow
{
public:
	struct FPointerToUberGraphFrame                    UberGraphFrame;                                            // 0x03A0(0x0008) (ZeroConstructor, Transient, DuplicateTransient)
	unsigned char                                      UnknownData_SFYU[0x8];                                     // 0x03A8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	{
		static auto ptr = UObject::FindClass(_xor_("AnimBlueprintGeneratedClass ABP_Prisoner_WheelBarrow.ABP_Prisoner_WheelBarrow_C"));
		return ptr;
	}
	...
	void ExecuteUbergraph_ABP_Prisoner_WheelBarrow(int EntryPoint);
	void AfterRead();
	void BeforeDelete();
