...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldNodeBase"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldNodeInt"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldNodeVector"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_1LRK[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.UniformInteger"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_MA0A[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.RadialIntMask"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldNodeFloat"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_JAU0[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.UniformScalar"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0XNI[0x7];                                     // 0x00D1(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.RadialFalloff"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_17HD[0x3];                                     // 0x00DD(0x0003) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.PlaneFalloff"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_2Z37[0xF];                                     // 0x00F1(0x000F) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.BoxFalloff"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5NA7[0x8];                                     // 0x00B8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  Transform;                                                 // 0x00C0(0x0030) (Edit, BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.NoiseField"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.UniformVector"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.RadialVector"));
		return ptr;
	}
...
public:
	float                                              Magnitude;                                                 // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OFZZ[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.RandomVector"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystemActor"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_1AS3[0x10];                                    // 0x0028(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystem"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_WRBC[0x10];                                    // 0x0448(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	unsigned char                                      SupportedSolvers[0x10];                                    // 0x0448(0x0010) UNKNOWN PROPERTY: ArrayProperty
	unsigned char                                      UnknownData_0BIK[0x18];                                    // 0x0468(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystemComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystemMetaData"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_O31H[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystemMetaDataIteration"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_WB07[0x7];                                     // 0x00B1(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.FieldSystemMetaDataProcessingResolution"));
		return ptr;
	}
...
public:
	float                                              Magnitude;                                                 // 0x00B0(0x0004) (Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_D6YS[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BBCV[0x7];                                     // 0x00C9(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.OperatorField"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.ToIntegerField"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.ToFloatField"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_K9RL[0x7];                                     // 0x00C1(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.CullingField"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class FieldSystemEngine.ReturnResultsTerminal"));
		return ptr;
	}
