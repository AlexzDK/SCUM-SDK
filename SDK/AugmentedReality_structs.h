...
struct FARSessionPayload
{
	...
	unsigned char                                      UnknownData_SOJZ[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARGeoAnchorUpdatePayload
{
	...
	unsigned char                                      UnknownData_06WY[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_FAMZ[0x3];                                     // 0x005D(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_IR5I[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_07BC[0xF];                                     // 0x0051(0x000F) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_B2Z4[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_RBRZ[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_5X5I[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARFaceUpdatePayload
{
	...
	unsigned char                                      UnknownData_M6MN[0x4];                                     // 0x003C(0x0004) MISSED OFFSET (PADDING)
...
{
	unsigned char                                      UnknownData_H81V[0x1];                                     // 0x0000(0x0001) MISSED OFFSET (PADDING)
...
{
	struct FARSessionPayload                           SessionPayload;                                            // 0x0000(0x0018) (BlueprintVisible, BlueprintReadOnly, NoDestructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OWPA[0x8];                                     // 0x0018(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FTransform                                  WorldTransform;                                            // 0x0020(0x0030) (BlueprintVisible, IsPlainOldData, NoDestructor, NativeAccessSpecifierPublic)
	...
	unsigned char                                      UnknownData_DXGC[0x7];                                     // 0x0079(0x0007) MISSED OFFSET (PADDING)
...
struct FARTraceResult
{
	...
	unsigned char                                      UnknownData_0N2M[0xB];                                     // 0x0005(0x000B) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_P7SV[0x18];                                    // 0x0048(0x0018) MISSED OFFSET (PADDING)
...
struct FARSkeletonDefinition
{
	...
	unsigned char                                      UnknownData_JMCE[0x4];                                     // 0x0004(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
struct FARSessionStatus
{
	...
	unsigned char                                      UnknownData_YD0S[0x7];                                     // 0x0011(0x0007) MISSED OFFSET (PADDING)
...
struct FARPose3D
{
	...
	unsigned char                                      UnknownData_A8GF[0x7];                                     // 0x0049(0x0007) MISSED OFFSET (PADDING)
