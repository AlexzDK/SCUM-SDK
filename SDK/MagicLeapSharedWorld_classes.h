...
{
public:
	unsigned char                                      UnknownData_4UDI[0x18];                                    // 0x0570(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapSharedWorld.MagicLeapSharedWorldPlayerController"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_3C70[0xA4];                                    // 0x032C(0x00A4) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapSharedWorld.MagicLeapSharedWorldGameMode"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapSharedWorld.MagicLeapSharedWorldGameState"));
		return ptr;
	}
