...
struct FCustomizedToolMenuSection
{
	...
	unsigned char                                      UnknownData_UF50[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
{
	Slate_ECustomizedToolMenuVisibility                Visibility;                                                // 0x0000(0x0001) ELEMENT_SIZE_MISMATCH (ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RCH8[0x3];                                     // 0x0000(0x0003) FIX WRONG TYPE SIZE OF PREVIOUS PROPERTY
...
struct FInputChord
{
	...
	unsigned char                                      UnknownData_TDXK[0x7];                                     // 0x0019(0x0007) MISSED OFFSET (PADDING)
...
struct FCustomizedToolMenu
{
	...
	unsigned char                                      UnknownData_DZI1[0xE0];                                    // 0x0108(0x00E0) MISSED OFFSET (PADDING)
