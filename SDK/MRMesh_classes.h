...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class MRMesh.MeshReconstructorBase"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_YHHK[0x4];                                     // 0x020C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WM0T[0x4];                                     // 0x0244(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_NKH8[0x20];                                    // 0x0250(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MRMesh.MockDataMeshTrackerComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZXX3[0x10];                                    // 0x0440(0x0010) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_KG9U[0x5];                                     // 0x0463(0x0005) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F1J7[0x80];                                    // 0x0480(0x0080) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MRMesh.MRMeshComponent"));
		return ptr;
	}
