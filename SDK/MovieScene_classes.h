...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSceneComponentImpersonator"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EV6R[0x5];                                     // 0x03F3(0x0005) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneCompiledData"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_NB72[0xB0];                                    // 0x0028(0x00B0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3S2O[0x18];                                    // 0x0218(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneCompiledDataManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneFloatDecomposer"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_CV1P[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_1U2L[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneBuiltInEasingFunction"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_XX96[0x8];                                     // 0x0028(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEasingExternalCurve"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEasingFunction"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_97QF[0x210];                                   // 0x0028(0x0210) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneEntitySystemGraph                SystemGraph;                                               // 0x0238(0x0138) (NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_RVU9[0xE8];                                    // 0x0370(0x00E8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEntitySystemLinker"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_I5VE[0x10];                                    // 0x0030(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEntitySystem"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_H29J[0x10];                                    // 0x0040(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEvalTimeSystem"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_NNPU[0x10];                                    // 0x0060(0x0010) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneKeyProxy"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEntityInstantiatorSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneMasterInstantiatorSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieScenePreAnimatedStateSystemInterface"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneCachePreAnimatedStateSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneRestorePreAnimatedStateSystem"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_TJ07[0x90];                                    // 0x0040(0x0090) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSequenceTickManager"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSpawnablesSystem"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_EXZK[0x18];                                    // 0x0038(0x0018) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_Q0SH[0x6];                                     // 0x0052(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_SCJL[0x3];                                     // 0x00B1(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_OP68[0x3];                                     // 0x00C5(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_YDEA[0x1D];                                    // 0x00CB(0x001D) MISSED OFFSET (PADDING)
...
public:
	...
	unsigned char                                      UnknownData_IDCI[0x7];                                     // 0x00E9(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FMovieSceneBoolChannel                      BoolCurve;                                                 // 0x00F0(0x0090) (Protected, NativeAccessSpecifierProtected)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneBoolSection"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_PR8G[0x8];                                     // 0x0180(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSpawnSection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0GX8[0x1];                                     // 0x0054(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_EJB2[0x2];                                     // 0x0056(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSpawnTrack"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_15PP[0x8];                                     // 0x0078(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_0Y33[0x7];                                     // 0x0081(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.TestMovieSceneTrack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.TestMovieSceneSection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_R68C[0x4];                                     // 0x005C(0x0004) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.TestMovieSceneSequence"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSubTrack"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.TestMovieSceneSubTrack"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_BEHR[0x4];                                     // 0x013C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneSubSection"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.TestMovieSceneSubSection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_V2UT[0x7];                                     // 0x0031(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneTrackInstance"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_V47M[0x3E8];                                   // 0x0028(0x03E8) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MJNF[0x3];                                     // 0x0461(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_6UKD[0x3];                                     // 0x0465(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_BJQY[0x4];                                     // 0x0494(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_L9U1[0x68];                                    // 0x0580(0x0068) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RLQ4[0x70];                                    // 0x0610(0x0070) MISSED OFFSET (PADDING)
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneCustomClockSource"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneEntityProvider"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieScenePlaybackClient"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneTrackTemplateProducer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.NodeAndChannelMappings"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneNodeGroup"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneNodeGroupCollection"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_6W3N[0x6];                                     // 0x011A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
...
public:
	...
	unsigned char                                      UnknownData_ZRGU[0x58];                                    // 0x0038(0x0058) MISSED OFFSET (PADDING)
...
{
public:
	unsigned char                                      UnknownData_DKAR[0x20];                                    // 0x0040(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneBlenderSystem"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneGenericBoundObjectInstantiator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneBoundSceneComponentInstantiator"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_5M0U[0xB0];                                    // 0x0040(0x00B0) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneTrackInstanceInstantiator"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MovieScene.MovieSceneTrackInstanceSystem"));
		return ptr;
	}
