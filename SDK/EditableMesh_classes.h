...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshAdapter"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_OUTD[0x9C];                                    // 0x003C(0x009C) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableGeometryCollectionAdapter"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_0JW7[0x390];                                   // 0x0028(0x0390) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<class UEditableMeshAdapter*>                Adapters;                                                  // 0x03B8(0x0010) (ZeroConstructor, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_OLQZ[0x8];                                     // 0x03C8(0x0008) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_3JVN[0x148];                                   // 0x03D4(0x0148) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_WN2H[0x1E4];                                   // 0x0524(0x01E4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMesh"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableMeshFactory"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_B960[0xA4];                                    // 0x003C(0x00A4) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class EditableMesh.EditableStaticMeshAdapter"));
		return ptr;
	}
