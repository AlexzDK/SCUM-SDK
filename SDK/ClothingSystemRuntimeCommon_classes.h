...
public:
	...
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeCommon.ClothConfigCommon"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeCommon.ClothSharedConfigCommon"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeCommon.ClothingAssetCustomData"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_WE0A[0x4];                                     // 0x010C(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F5RE[0x4];                                     // 0x01EC(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeCommon.ClothingAssetCommon"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0S72[0x20];                                    // 0x0168(0x0020) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class ClothingSystemRuntimeCommon.ClothLODDataCommon_Legacy"));
		return ptr;
	}
