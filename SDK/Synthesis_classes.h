...
public:
	...
	unsigned char                                      UnknownData_I2K1[0x718];                                   // 0x06E8(0x0718) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SynthComponentMonoWaveTable"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_ZKE4[0x18];                                    // 0x06C8(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SynthComponentToneGenerator"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_1VVP[0x108];                                   // 0x06E8(0x0108) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SynthSamplePlayer"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SynthesisUtilitiesBlueprintFunctionLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_M7ID[0x7];                                     // 0x0119(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_RP1G[0x6];                                     // 0x039A(0x0006) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_O3MT[0x10];                                    // 0x03F0(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SynthKnob"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.ModularSynthPresetBank"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.ModularSynthLibrary"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_40KD[0x6BC];                                   // 0x06C4(0x06BC) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.ModularSynthComponent"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_H49F[0x58];                                    // 0x0068(0x0058) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectBitCrusherPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_R9F8[0xA0];                                    // 0x0068(0x00A0) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectChorusPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_9C6Q[0x50];                                    // 0x0068(0x0050) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectDynamicsProcessorPreset"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_02RA[0x10];                                    // 0x00C0(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.EnvelopeFollowerListener"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_L10N[0x34];                                    // 0x0068(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectEnvelopeFollowerPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WXKO[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectEQPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_L1TG[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectFilterPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WLZN[0x34];                                    // 0x0068(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectFoldbackDistortionPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_5EGO[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectMidSideSpreaderPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_DSGZ[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectPannerPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_ZVJF[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSourceEffectPhaserSettings                 Settings;                                                  // 0x00A0(0x0010) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectPhaserPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_CEB3[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectRingModulationPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_FEKB[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectSimpleDelayPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_RD70[0x4C];                                    // 0x0068(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectStereoDelayPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_KFG1[0x30];                                    // 0x0068(0x0030) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SourceEffectWaveShaperPreset"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_C8TI[0x3];                                     // 0x0045(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	TArray<float>                                      IRData;                                                    // 0x0048(0x0010) (ZeroConstructor, Deprecated, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.AudioImpulseResponse"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_7ZDP[0x56];                                    // 0x009A(0x0056) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectConvolutionReverbPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_60VK[0x34];                                    // 0x0068(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_TERJ[0x4];                                     // 0x00B4(0x0004) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectDelayPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_WD6L[0x34];                                    // 0x0068(0x0034) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectFilterSettings                 Settings;                                                  // 0x009C(0x000C) (Edit, BlueprintVisible, NoDestructor, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectFilterPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_IWXF[0x38];                                    // 0x0068(0x0038) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectFlexiverbPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_684Q[0x48];                                    // 0x0068(0x0048) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectMultibandCompressorSettings    Settings;                                                  // 0x00B0(0x0020) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectMultibandCompressorPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_Y987[0x4C];                                    // 0x0068(0x004C) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectStereoDelayPreset"));
		return ptr;
	}
...
{
public:
	unsigned char                                      UnknownData_5AIR[0x40];                                    // 0x0068(0x0040) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	struct FSubmixEffectTapDelaySettings               Settings;                                                  // 0x00A8(0x0018) (Edit, BlueprintVisible, NativeAccessSpecifierPublic)
	unsigned char                                      UnknownData_TEDD[0x18];                                    // 0x00C0(0x0018) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.SubmixEffectTapDelayPreset"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_0IBY[0x2];                                     // 0x03FA(0x0002) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_9KP1[0x7];                                     // 0x0401(0x0007) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_HGC8[0x10];                                    // 0x0468(0x0010) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.Synth2DSlider"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_S11C[0x3B8];                                   // 0x06C8(0x03B8) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.GranularSynth"));
		return ptr;
	}
...
public:
	...
	unsigned char                                      UnknownData_5GRE[0x3];                                     // 0x0039(0x0003) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_MVZQ[0x4];                                     // 0x0044(0x0004) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_F70H[0x117];                                   // 0x0059(0x0117) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class Synthesis.MonoWaveTableSynthPreset"));
		return ptr;
	}
