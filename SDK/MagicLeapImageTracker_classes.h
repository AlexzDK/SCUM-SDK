...
public:
	...
	unsigned char                                      UnknownData_4M5V[0x1];                                     // 0x0217(0x0001) MISSED OFFSET (FIX SPACE BETWEEN PREVIOUS PROPERTY)
	...
	unsigned char                                      UnknownData_4Z4W[0x8];                                     // 0x0268(0x0008) MISSED OFFSET (PADDING)


	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapImageTracker.MagicLeapImageTrackerComponent"));
		return ptr;
	}
...
public:
	...
	static UClass* StaticClass()
	{
		static auto ptr = UObject::FindClass(_xor_("Class MagicLeapImageTracker.MagicLeapImageTrackerFunctionLibrary"));
		return ptr;
	}
